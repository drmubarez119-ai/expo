...
- Remove `UNSTABLE_routeNamesChangeBehavior` and the unhandled-state replay from `useNavigationBuilder`. ([#TODO](https://github.com/expo/expo/pull/TODO) by [@Ubax](https://github.com/Ubax))
